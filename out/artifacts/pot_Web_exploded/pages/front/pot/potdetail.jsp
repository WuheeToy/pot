...
.uum .ffc {
	...
	.kkh {padding: 30px 0; border-top: dashed 1px #737373}
	.kkh .ttt {font-weight: 800; font-size: 26px; margin-bottom: 10px;}
	._fs64 { font-size: 64px;}
...
@media screen and (max-width:720px){
	...
	.kkh .ttt {font-size: 16px;}
	._fs64 { font-size: 32px;}
	._fs18 { font-size: 14px;}
}
</style>
</head>
<body>
<div class="warpper zszs" style="background-color: #fff; position: relative">
	...
	<div class="number EC mb30">
		<div class="col mr20">
			<p>紫砂壶鉴定证号</p>
			<span>${design.jdzh}
			<a style="font-size: 16px; margin-left: 30px; color:#bb1417"><img src="${ctx}images/ppa.jpg" style="display: inline; height: 16px; margin-right: 10px;">查看证书</a>
			</span>
		</div>
	</div>
	<ul class="info mb30">
