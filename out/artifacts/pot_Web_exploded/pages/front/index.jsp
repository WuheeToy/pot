...
<jsp:include page="/pages/header-nav.jsp"></jsp:include>
  ...
  <div carousel-item=""  style="height: 250px;" >
    <div><a class="item"><img  style="width:  100%;height: 100%"  src="${ctx}images/header_banner1.jpg" alt=""></a></div>
    <div><a class="item"><img style="width:  100%;height: 100%"  src="${ctx}images/header_banner2.jpg" alt=""></a></div>
                ...
                <div class="warp oh">
                  ...
                  <c:forEach var="designlist" items="${designlist}" varStatus="status"  begin="0" end="3" step="1">  
                            ...
                            <div class="change">
                                ...
                                <p class="info mb10 ph_mb5 cb"><span>作者：${designlist.author}</span><span>编号：${designlist.design_Id}</span><span class="ph_dn">泥料：${designlist.niliao}</span><span class="ph_dn">容量：${designlist.rongliang}</span></p>
...
$(document).ready(function(){
	alert(123)
	setTimeout(function(){AngularJS_Init();},10);
});
