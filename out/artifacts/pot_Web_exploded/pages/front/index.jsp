                            ...
                            <c:forEach var="art" items="${artlist}" varStatus="status" begin="0" end="0" step="1">
                                <li>
                                    <div class="pg">
                                        ...
                                        <div class="info">
                                            <div class="box">
                                                <p class="fb"><span class="mr20">${art.name}</span><span class="fs14">职称：${art.title}</span>
                                                </p>
                                                <p>${art.title_By}</p>
                                            </div>
                                        </div>
            ...
            <div class="bgStyle-black">
                <div class="warp cb">
                    <div class="profun">
                        ...
                        <p class="fs12">
                            制定行业规范振兴紫砂事业，通过融合多项目技术建立真正意义上的紫砂交易平台，“鉴真章”寓意平台的鉴真功能，“真章”意味着真实结果，也体现我们平台坚持正品，维护版权的决心。</p>
                ...
                <div class="warp oh">
                    ...
                    <ul class="artisans cb">
                        <c:forEach var="art" items="${artlist}" varStatus="status" begin="0" end="7" step="1">
                            <li class="osScale">
                                <img style="width: 210px;height: 210px" src="${ctx}${art.img}">
                                <div class="info">
